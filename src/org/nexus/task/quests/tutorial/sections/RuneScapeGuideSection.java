...
import org.nexus.task.quests.tutorial.events.DisableAudioEvent;
import org.nexus.task.quests.tutorial.events.EnableFixedModeEvent;
import org.nexus.task.quests.tutorial.events.ToggleRoofsHiddenEvent;
import org.nexus.task.quests.tutorial.events.ToggleShiftDropEvent;
        ...
        switch (configValue) {
            ...
            case 1:
                if (suggestedNameWidget.get(getWidgets()).isPresent()) {
                    ...
                    if (getKeyboard().typeString(NexusScript.username.split("@")[0])) {
