...
public final class LoginEvent extends Event {
	...
	public final int execute() throws InterruptedException {
		...
		if(context.client.isLoggedIn() && getLobbyButton() == null) {
			getBot().getScriptExecutor().resume();
			setFinished();
		}
		if (!(NexusScript.currentTask != null && NexusScript.currentTask.getTaskType() == TaskType.BREAK && !NexusScript.currentTask.isFinished(context))) {
